"""
ClientApplicationState - Client-side state manager with observer pattern.

Manages application state transitions and notifies observers.
Supports two observer types:
...
class ClientApplicationState:
    """
    Manages client application state with observer pattern.
    ...
    def __init__(self, config: Dict, root=None):
        """
        Initialize ClientApplicationState.
