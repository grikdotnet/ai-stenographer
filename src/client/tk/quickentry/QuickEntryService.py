...
if TYPE_CHECKING:
    ...
    from src.client.tk.quickentry.QuickEntryController import QuickEntryController
...
class QuickEntryService:
    ...
    def __init__(
        ...
        from src.client.tk.quickentry.QuickEntrySubscriber import QuickEntrySubscriber
        from src.client.tk.quickentry.QuickEntryController import QuickEntryController
