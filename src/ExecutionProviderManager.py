...
class ExecutionProviderManager:
    ...
    def _detect_gpu_type_windows(self) -> str:
        ...
        # Parse all GPU names (wmic returns header + multiple GPU lines)
        has_discrete = False
        ...
        # PRIORITY: Discrete GPU wins if both present
        if has_discrete:
            if has_integrated:
    ...
    def _classify_gpu_name(self, name: str) -> str:
        ...
        # AMD integrated: "radeon" + "graphics" but not discrete models
